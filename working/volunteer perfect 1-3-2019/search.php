							...
							<div class="row">
								<div class="col-lg-4 col-md-6">
									<label class="check">Volunteer
										...
										<input type="checkbox" id="1" class="category" <?php if(isset($_SESSION["checkbox1"])){ echo 'checked'; } else if(isset($category) && $category==1){ echo 'checked';  }?>>
								...
								<div class="col-lg-4 col-md-6">
									<label class="check">Teach
										<input type="checkbox" id="2" class="category" <?php if(isset($_SESSION["checkbox2"])){ echo 'checked'; }   else  if(isset($category) && $category==2){ echo 'checked'; } ?>>
										<span class="checkmark" ></span>
									</label>
								</div>
								<div class="col-lg-4 padding-top-tablet">
									<label class="check">Intern
										<input type="checkbox" class="category" id="3" <?php if(isset($_SESSION["checkbox3"])){ echo 'checked'; }  else  if(isset($category) && $category==3){ echo 'checked'; } ?>>
										<span class="checkmark"></span>
									</label>
								</div>
							</div>
...
$('.category').click(function() {
	...
	var data1 = 'checkbox1='+ checkbox1 + '&checkbox2='+ checkbox2 + '&checkbox3='+ checkbox3; 
