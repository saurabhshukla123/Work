...
{
$p=new project();
$fields="p.title,p.id,p.country_id,p.city_id,p.project_video_url,o.name as orgname,impact_description,overview_description";
...
while ($result = $row->fetch_assoc()) {
	...
	$overview_description=$result['overview_description'];
