...
$(document).ready(function() {
    ...
    if ($(window).width() >= 768) {
    	var swiper = new Swiper('.four-block-swiper', {
    		nextButton: $(".organize-carousel-outer").find('.swiper-button-next'),
    		prevButton: $(".organize-carousel-outer").find('.swiper-button-prev'),
    		slidesPerView: 4,
    		loop: false,
    		loopedSlides: 4,
    		breakpoints: {
    ...
    var galleryTop = new Swiper('.gallery-top', {
        nextButton: $(".gallery-swiper-nav").find('.swiper-button-next'),
        prevButton: $(".gallery-swiper-nav").find('.swiper-button-prev'),
        spaceBetween: 10,
        loop: true,
        loopedSlides: 6
    });
    ...
    $(window).scroll(function() {
        ...
        console.log($(".wide-column").innerHeight());
