...
/**
 * Function to get role of logged-in user.
 */
...
/**
 * Function to check if logged-in user access page.
 */
function checkLoggedInUserAccesspage($fileName)
{
	$siteURL = explode("/",$_SERVER['REQUEST_URI']);
	if(checkIfLogin()) {
		if($siteURL[3] == $fileName){
