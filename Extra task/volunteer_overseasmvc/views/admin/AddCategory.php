...
if(!empty($categoriesPageData->categorydetails)){ 
	foreach($categoriesPageData->categorydetails as $row){
		$name = $row->name;
...
<html lang="en">
	...
	<main style="background-color:#f8f9fa;">
		...
		<div class="container" style="background-color:white;">
			<form name="admin_addcategory"  onsubmit="return validateForm()" method="post" action="AddCategory"  enctype="multipart/form-data">
			 <div class="row pt-3">
			 	<div class="col-lg-12">
					 <h1 class="text-muted">Category Lists</h1>
				</div>
			 </div>
			 <div class="row pt-3">
			 	<div class="col-lg-6">
			 ...
			 <div class="row pt-5">
			 	<div class="col-lg-12 row justify-content-center">
				 		<div class="row">
				        	...
				        	<input type="button" class="btn pinkbg text-light bg-danger height-31px"  onClick="document.location.href='CategoryLists'" name="cancel" value="CANCEL" />
