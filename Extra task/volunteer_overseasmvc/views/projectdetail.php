...
<body>
	<div>
		<header class="headerformat" style="background-image:linear-gradient(to bottom, rgba(0, 0, 0, 0)0%, rgba(0, 0, 0, 0.06) 10%, rgba(0, 0, 0, 0.15) 22%,rgba(0, 0, 0, 0.72) 75%, rgba(0, 0, 0, 0.84) 89%, rgba(0, 0, 0, 0.91) 100%),url('<?php echo UPLOAD_IMAGE_URL; echo  $projectimage;?>');">
			...
			<a href="#" class="bluebold" data-toggle="modal" data-target="#viewphotos">
			...
			<div class="col-lg-8 col-md  col-sm-12">
				...
				<div class="row">
					<div class="col-md-2 gutter-plan-gap col-2" >
						<img src="<?php echo UPLOAD_IMAGE_URL;
                echo $org_logo; ?>"   width="69px" height="70px" class="border border-secondary">
					</div>
				...
				<section id="DATES">
					...
					<div class="pt-4 pb-4 owl6">
						...
						<?php 
							...
							if (!empty($projectPageData->startMonths)) {
								$data[]= array(); 
								?>
								<?php
								$i=0;
								foreach ($projectPageData->startMonths as $value) {	
								...
								<div class="item">
										<table class="table-header-blue text-light bordercolor" border="1" width="100%">
												...
												<tr>
												<?php foreach ($projectPageData->project_start_dates as $value) { 
													$monthnew=date('F', strtotime($value->start_date));
							...
							<div class="slider-inner">
                             ...
                             <?php if (!empty($projectPageData->project_images)) {
								foreach ($projectPageData->project_images as $value) {?>
									<li><a class="ns-img" href="<?php echo UPLOAD_IMAGE_URL;
							...
							<div id="thumbnail-slider">
                             ...
                             <?php if (!empty($projectPageData->project_images)) {
   							 foreach ($projectPageData->project_images as $value) {?>
										...
										<li>
											<a class="thumb" href="<?php echo UPLOAD_IMAGE_URL;
       						 echo $value->image; ?>"></a>
											<span>0</span>
										</li>
								    <?php }
