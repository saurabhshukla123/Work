...
if (isset($_SESSION['role'])) {
	...
	//	$conn = OpenCon();
		...
		{	$_SESSION["city"]="";	
			...
			$project_data=new projects();
		     $result=$project_data->getprojectdetails($projectid);
		...
		//	$conn = OpenCon();
		     $userverify=new projects();
		     $result3=$userverify->verifyUser($user_id,$projectid);
	...
	//	$conn = OpenCon();
		...
		$project_detail=new projects();
		$result=$project_detail->getprojectdetails($projectid);
			 ...
			 <div class="row pt-1">
			 	<div class="col-lg-6">
					...
					//	$conn = OpenCon();
						...
						$org_data=new Organizations();
						$result=$org_data->getAllOrganizationDetail();
						
						}
						else{
						$id=$_SESSION['id'];
						$org_data_org=new Organizations();
						$result=$org_data_org->getAllOrganizationDetailUser($id);
			 	...
			 	<div class="col-lg-6">
			 		...
			 		<select class="form-control" name="category" id="category">
			 				<option value="0">please select</option>
                             <?php					
						$sql_categories=new categories();
						$result=$sql_categories->getallcategories();
						if ($result->num_rows > 0) {
			 ...
			 <div class="row pt-1">
			 	<div class="col-lg-6">
			 			<select class="form-control" name="activity" id="activity">
			 				<option value="0">please select</option>
                             <?php
						$sql_activity=new  activity();
						$result=$sql_activity->getallactivities();
						if ($result->num_rows > 0) {
			 	...
			 	<div class="col-lg-6">
					 ...
					 <!-- <option value="0">please select</option> -->
                             <?php
									...
									$result = $countries_data->getallcountries();
