document.write(
	...
	'<script type="text/javascript" src="'+assets_url+'js/swiper.jquery.min.js"></script>' +
	...
	'<script type="text/javascript" src="'+assets_url+'js/one.js"></script>' +
	'<script type="text/javascript" src="'+assets_url+'js/second.js"></script>'+
	'<script type="text/javascript" src="'+assets_url+'ckeditor/ckeditor.js"></script>'
	);
