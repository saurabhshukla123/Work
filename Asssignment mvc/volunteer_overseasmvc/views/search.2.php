...
<head>
	...
	<link href="public/css/A_green.css" rel="stylesheet" type="text/css" />
</head>
	...
	<header class="headerformatcontact-none" >
				<nav class="navbar navbar-expand-sm" id="navigation">
								...
								<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#myNavbar">
		    						<span class=" "><img src="<?php echo IMAGE;?> images/menu.svg"></span>
		 						</button>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-3">
							<div class="search-select">
								<input type="text" name="country"  class="form-control" style="height: 47px;" placeholder="country" value="<?php ?>" id="country">
							</div>
						</div>
						<div class="col-lg-3 col-md-3">
			...
			<div class="col-lg-12 col-md-12">
				<div class="row">
					...
					// $statement = "projects AS p INNER JOIN organizations AS o on p.organization_id=o.id  INNER JOIN project_costs AS pc  ON pc.project_id=p.id"; //you have to pass your query over here
						...
						$conditions3="category_id='$category' AND country_id='$countryid' AND activity_id='$activity'".$value." LIMIT {$startpoint} , {$limit}";
						$res = $p2->select($fields3,$tablename3,$conditions3);
						
						// if(isset($_SESSION["query"]))
						// {
							
						// $conditions4count=$_SESSION["query"];
						// // echo $conditions4count;
					...
					//		$conditions4count="category_id='$category' AND country_id='$countryid' AND activity_id='$activity' ";
							...
							//$_SESSION["query"]=$conditions4count;
						//}
						$re1 = $p2->count($fields3,$tablename3,$conditions3);
