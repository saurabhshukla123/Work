...
class projects extends BaseModel
{
    ...
    function select_query($fields,$tablename,$conditions)
    { 
        $view_data_history = new BaseModel();
        $data = array();        
    ...
    function insert_records($organization,$activity,$category,$title,$imgpath,$min_age,$max_age,$overview_description,$accommodation_description,$NULL6,$video,$city,$country,$NULL1,$NULL2,$NULL3,$NULL4,$NULL5,$status,$null,$c_date)
    {
        $table = 'projects';
