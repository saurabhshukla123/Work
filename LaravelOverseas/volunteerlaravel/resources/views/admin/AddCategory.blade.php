...
<html lang="en">
	...
	<main style="background-color:#f8f9fa;">
		...
		<div class="container" style="background-color:white;">
			<form name="admin_addcategory"  onsubmit="return validateForm()" method="post" action="Category/addEditData"  enctype="multipart/form-data">
			 ...
			 <div class="row pt-5">
			 	<div class="col-lg-12 row justify-content-center">
				 		<div class="row">
				        	...
				        	<input type="button" class="btn pinkbg text-light bg-danger height-31px"  onClick="document.location.href='CategoryList'" name="cancel" value="CANCEL" />
