                    ...
                    <div class="container">
                        ...
                        <!-- code ends for alert -->
                            <div class="section-title text-center">
                                ...
                                <a href="CategoryList/edit/2/2">  <button type="button" class="btn btn-fill">Add Category</button></a>
                                </div>
                            </div>
                                ...
                                <table class="table admin-table table-bordered table-striped">
                                    ...
                                    <tr>
                                      <?php     $i++;?>
                                        ...
                                        <td>
                                            <div class="button-outer">
                                            <a class="text-light" href="CategoryList/edit/1/<?php  echo $row->id;?>" >  <button type="button"class="btn btn-fill" id="" >Edit</button></a>
