                    ...
                    <div class="container">
                        ...
                        <!-- code ends for alert -->
                            <div class="section-title text-center">
                                ...
                                <a href="CityList/edit/2/2">  <button type="button" class="btn btn-fill">Add City</button></a>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table admin-table table-bordered table-striped">
                                   ...
                                   <?php $i++; ?>
                                        ...
                                        <td>
                                            <div class="button-outer">
                                            <a class="text-light" href="CityList/edit/1/<?php  echo $row->id;?>" >  <button type="button"class="btn btn-fill" id="" >Edit</button></a>
