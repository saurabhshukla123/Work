...
<html lang="en">
    ...
    <body>
                ...
                <section class="admin-section">
                    <div class="container">
                        ...
                        <div class="section-title text-center">
                                ...
                                <a href="ActivityList/edit/2/2">  <button type="button" class="btn btn-fill">Add Activity</button></a>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table admin-table table-bordered table-striped">
                                    ...
                                    <?php $i++;?>
                                        ...
                                        <td>
                                            <div class="button-outer">
                                            <a class="text-light" href="ActivityList/edit/1/<?php  echo $row->id;?>" >  <button type="button"class="btn btn-fill" id="" >Edit</button></a>
        ...
        <script type="text/javascript" src="<?php echo ASSETS_URL;?>js/activityList.js"></script>
    </body>
</html>