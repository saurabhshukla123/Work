...
<?php 
	$name = $row->name;
	$image = $row->image;
	Request::session()->put('imageurl',  $row->image);
?>
@endforeach
<?php } }
?>
...
<html lang="en">
	...
	<main style="background-color:#f8f9fa;">
		...
		<div class="container" style="background-color:white;">
			<form name="admin_addcountry"  onsubmit="return validateForm()" method="post" action="addEditData"  enctype="multipart/form-data">
			 ...
			 <div class="row pt-5">
			 	<div class="col-lg-12 row justify-content-center">
				 		<div class="row">
				        	...
				        	<input type="button" class="btn pinkbg text-light bg-danger height-31px"  onClick="document.location.href='CountryList'" name="cancel" value="CANCEL" />
