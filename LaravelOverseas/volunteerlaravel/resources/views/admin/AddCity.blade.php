...
<html lang="en">
	...
	<main style="background-color:#f8f9fa;">
		...
		<div class="container" style="background-color:white;">
			<form name="admin_addcountry"  onsubmit="return validateForm()" method="post" action="City/addEditData"  enctype="multipart/form-data">
			 	...
			 	<div class="col-lg-6">
					<select id="country" name="country" class="form-control">
						@foreach ($country as $row)
							<option value="<?php echo $row->id; ?>"  id="<?php echo $row->id; ?>"  <?php echo ($row->id == $countryid) ? "selected" : ""; ?>><?php echo $row->name; ?></option>
						@endforeach					
					</select>
				</div>
			</div>
			 ...
			 <div class="row pt-5">
			 	<div class="col-lg-12 row justify-content-center">
				 		<div class="row">
				        	...
				        	<input type="button" class="btn pinkbg text-light bg-danger height-31px"  onClick="document.location.href='CityList'" name="cancel" value="CANCEL" />
