...
<html lang="en">
	...
	<main style="background-color:#f8f9fa;">
		...
		<div class="container" style="background-color:white;">
			<form name="admin_addcountry"  onsubmit="return validateForm()" method="post" action="AddCity"  enctype="multipart/form-data">
			 <div class="row pt-3">
			 	<div class="col-lg-12">
					 <h1 class="text-muted">City</h1>
				</div>
			 </div>
			 <div class="row pt-3">
			 	<div class="col-lg-6">
			 	...
			 	<div class="col-lg-6">
			 		<span class="blue font-14px">Country Name</span>
			 	</div>
			</div>
			 <div class="row pt-1">
			 	<div class="col-lg-6">
				...
				<?php if (!empty($cityPageData->country)) {
												foreach ($cityPageData->country as $activity_value) {

													?>
																<option value="<?php echo $activity_value->id; ?>"  id="<?php echo $activity_value->id; ?>"  <?php echo ($activity_value->name == $countryname) ? "selected" : ""; ?>><?php echo $activity_value->name; ?></option>
			 ...
			 <div class="row pt-5">
			 	<div class="col-lg-12 row justify-content-center">
				 		<div class="row">
				        	...
				        	<input type="button" class="btn pinkbg text-light bg-danger height-31px"  onClick="document.location.href='CityLists'" name="cancel" value="CANCEL" />
