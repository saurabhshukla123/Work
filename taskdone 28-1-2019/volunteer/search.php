			         		...
			         		<div style="padding-left: inherit;" class="d-sm-none d-none d-md-none d-lg-block">
			         			<button type="button" id="morefilter" class="btn button-border">
			         	          ...
			         	          <div class="d-sm-block d-block d-lg-none d-md-block">
												...
												<button type="button" class="btn btn-info btn-lg button-border text-center"  style="width:57%;" data-toggle="modal" data-target="#testModal">...<span class="badge-text badge"  style="top:-34px; left:26px;">4</span>
												</button>
...
<div class="container">
             		...
             		<div class="row pb-3">
             			...
             			<div class="col-7">
             				...
             				<div class="col-10 font-size-11">
             				 <span class="blue">Volunteer</span> in <span class="blue">Combodia</span> for <span class="blue">Animal Conversation</span>
             			  </div>
             			<div class="col-2">
             			...
             			<div class="col-5 border-left">
             				<button type="button" id="morefilter1" class="btn button-border width-full padding-top-10 border-no-radius" style="width:100%;height: 36px;padding: 7px;">
									  More filters
			...
			<div class="panel1" id="panel1">
		         <div class="row">
		         	<div class="col-lg-12 pt-1">
		         		<div class="row"> <div class="col-12 text-center" style="height:20px;">
             		  <label class="display-close-none" >&#10006;</label>	
             		  </div>
			...
			<div class="row pb-3 pt-2">
				<div class="col-lg-8 col-md-8 col-6">
					<span><lable class="font-16px">320 Result</lable></span>
				</div>
				<div class="col-lg-4 col-md-4 col-6"><span class="float-right" style="font-size:14px;" >
					Sort by:
...
<?php 
for ($x = 0; $x <= 10; $x++) {
   	?>		<div class="row search_page pt-2">
				<div class="col-lg-12 col-md-12">
					<div class="row">
						<div class="col-lg-4 col-md-4">
							<div class="image">
						 				<div id="carouselExampleControls<?php echo $x;?>" class="carousel slide" data-ride="carousel">
    											...
    											<div class="carousel-item">
	 											 ...
	 											 <a class="carousel-control-prev" href="#carouselExampleControls<?php echo $x;?>" role="button" data-slide="prev">
	    												<span class="carousel-control-prev-icon" aria-hidden="true"></span>
	    														<span class="sr-only">Previous</span>
	 														</a>
															  <a class="carousel-control-next" href="#carouselExampleControls<?php echo $x;?>" role="button" 				data-slide="next">
...
$(window).scroll(function() {     
 ...
 $("#navigation").addClass('small-header');      }
    else {    $("#navigation").removeClass('small-header'); 
    } 
    });  
        </script>
         <script>
