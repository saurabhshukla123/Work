...
// $headers = 'From:'. $email1 . "rn"; // Sender's Email
...
// $subject ="Related to contact queries";
// $message =$_POST['message'] ;
// $email2=$_POST['email'];
// $email1="saurabh.internalmail.com";
// $headers = 'From:'. $email2 . "rn"; // Sender's Email
// $headers .= 'Cc:'. $email1 . "rn"; 
// mail($email1, $subject, "Thank you", $headers);
}
