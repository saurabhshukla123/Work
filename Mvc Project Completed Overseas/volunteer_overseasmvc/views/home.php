					...
					<div class="row" style="justify-content: center;">
						<div class="col-lg-9 col-md-12 col-12 font-size-mobile-home d-sm-block d-md-none d-lg-none">
							...
							<div class="row no-gutter border-round-homepage">
								<div class="col-3">
									<label class="border-no-right form-control pink border-round-left " style="display: flex;">Type</label>
								</div>
								<div class="col-9">
									<select class="form-control border-round-right border-no-left" id="desktop_banner_category" name="desktop_banner_category">
							...
							<div class="row no-gutter border-round-homepage pt-2">
								<div class="col-4">
									<label class=" border-no-right form-control pink border-round-left" style="display: flex;">Location</label>
								</div>
								<div class="col-8">
									
										<input type="text" class="form-control border-round-right border-no-left" placeholder="Anything"  id="anywheremobile"  name="anywheremobile">
								</div>
							</div>
							<div class="row no-gutter border-round-homepage pt-2">
								<div class="col-4">
									<label class="form-control pink border-round-left border-no-right" style="display: flex;">Activity</label>
								</div>
								<div class="col-8">
									<select class="form-control border-round-right border-no-left"  id="desktop_banner_activity" name="desktop_banner_activity">
									<option value="">Please Select</option>
						...
						<div class="col-lg-9 col-md-12 col-12 font-size-mobile-home display-none-home">
							<div class="row no-gutter">
								<div class="col-md-4  text-light text-center display-flex">
									<label class="form-control bg-transparent border-none size-15px">Type</label>
									<div class="select2">
								...
								<div class="col-md-3 text-light text-center display-flex">
									<label class="form-control bg-transparent border-none size-15px">Location</label>
								...
								<div class="col-md-3 text-light text-center display-flex">
									<label class="form-control bg-transparent border-none size-15px">Activity</label>
									<div class="select1">
								...
								<div class="col-md-2 text-light text-center display-flex">
									<label class="form-control bg-transparent border-none"> </label>
		...
		<div class="row pr-3 pt-2">
			<div class="col-md-12">
				<div class="owl-two owl-carousel owl-theme pb-5">
					...
					<div class="item" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0)0%, rgba(0, 0, 0, 0.06) 10%, rgba(0, 0, 0, 0.15) 22%,rgba(0, 0, 0, 0.72) 75%, rgba(0, 0, 0, 0.84) 89%, rgba(0, 0, 0, 0.91) 100%),url('<?php echo UPLOAD_IMAGE_URL; echo $row->country_image;?>');height:200px;  background-size:cover;">
					 
						<a href="#">
							<h5 class="owl-carousel-second-slider-red pink"><?php echo $row->total_projects;?> Projects in </h5>
						</a>
						<a href="search?countryname=<?php echo $row->country_name; ?>">
		...
		<div class="row pr-3 pt-2 ">
			<div class="col-md-12">
				...
				<?php if(!empty($indexPageData->affordable_project)){
                    ...
                    ?>
					<div class="item">
						<div style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0)0%, rgba(0, 0, 0, 0.06) 10%, rgba(0, 0, 0, 0.15) 22%,rgba(0, 0, 0, 0.72) 75%, rgba(0, 0, 0, 0.84) 89%, rgba(0, 0, 0, 0.91) 100%),url('<?php echo UPLOAD_IMAGE_URL; echo $row->image;?>');height:320px;  background-size:cover;">
