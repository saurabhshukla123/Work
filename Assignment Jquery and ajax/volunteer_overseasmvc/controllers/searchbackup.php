...
class Search extends BaseController
{
    ...
    public function ajax()
    {
        ...
        {
              //  $value=$minimumage;
              if(isset($checkbox1)  && $checkbox1!=""  || isset($checkbox2) && $checkbox2!="" || isset($checkbox3) && $checkbox3!="")
              {
       ...
       // $this->load_view('searchData', array('searchPageData' => $json_format));
    ...
    // print_r("activity id");
    // print_r($activity);
    // print_r($searchPageDataAjax->total_result);
