...
class OrganizationLists extends BaseController
{
    ...
    public function index()
    {
        ...
        {                                             
            $result['organizationdetails']=$this->organizationmodel->getAllOrganizationDetails();
        }
        else if($_SESSION['role']=="organization")
        {
        $user=$_SESSION['id'];
        $result['organizationdetails']=$this->organizationmodel-> getAllOrganizationDetailUser($user);
        }
