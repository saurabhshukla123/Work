...
{
$p=new project();
$fields="p.title,p.id,p.country_id,p.city_id,p.project_video_url,o.name as orgname";
$tablename="projects as p INNER JOIN organizations as o on p.organization_id=o.id";
$id=$_SESSION["project_id"];
$conditions="p.id='$id'";

$row=$p->select($fields,$tablename,$conditions);

//$row=$p->get_details_project($_SESSION["project_id"]);
while ($result = $row->fetch_assoc()) {
	$projectname=$result['title'];
	$orgname=$result['orgname'];
	$countryname=$p->get_details_country($result['country_id']);
	
	$cityname=$p->get_details_city($result['city_id']);
}
}
...
<body>
		...
		<header class="headerformat">
			...
			<div class="bg-light button-radius p-2">
				<a href="gallery.html" class="bluebold" data-toggle="modal" data-target="#viewphotos">
					<img src="images/photos-icon.png" alt="View Photos" title="view Photos" /> View Photos
				</a>
			</div>
		</header>
	</div>
			...
			<div class="col-lg-8 col-md  col-sm-12">
					...
					<div class="col-md-4 col-sm-12">
						<div class="row padding-bottom-index">
							<div class="col-md-2 col-2 div1-gutters1-index">
								<img src="images\map.png " class="pl-4" height="26px" alt="Kumasi Gana" title="Khumasi Gana" style="padding-top: 5px;padding-left: 7px;">
							</div>
					...
					<div class="col-md-12 col-12" style="padding-bottom: 15px;margin-top: -10px;">	
							<div class="d-md-block d-sm-block d-lg-none">
									<lable class="text-muted">
										<span class="blue">16 People</span> are viewing this program
									</lable>
								</div>			
					</div>
				</div>
				<div class="row">
					<div class="col-md-2 gutter-plan-gap col-2">
						<img src="images/play-logo.png" alt="Plan my gap" title="Plan my gap" height="70px" class="border border-secondary">
					</div>
					<div class="col-md-10 pt-3 col-8">
						<h3 class="bluebold  gap-mobile-sm">Plan My Gap Year</h3>
					</div>
				</div>
					...
					<div class="col-md-4 col-6">
						<div class="row">
							<div class="col-md-1 col-12 index-mobile-padding">
								<img src="images/icon1.png" class="img-ico-height">
							</div>
							<div class="col-md-10 col-12 index-mobile-padding">
								<span class="text-muted"> From $714 for 2 Weeks
								</span>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 div1-gutters-top col-6">
						<div class="row">
							...
							<div class="col-md-10 col-12">
								<span class=" text-muted">2-24 Weeks</span>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-12">
						<div class="row">
							<div class="col-md-1 col-sm-1 col-12 index-mobile-padding">
								<img src="images/icon4.png" class="img-ico-height" alt="18 and older" title="18 and older">
							</div>
							<div class="col-md-10 col-sm-10 col-12 index-mobile-padding">
								<span class=" text-muted"> 18 And Older</span>
							</div>
						</div>
					</div>
				</div>
				...
				<section id="Description">
					...
					<div class="row">
						<div class="col-md-12">
							<p class="paragraph">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nisi turpis, tincidunt nec ornare at, vestibulum
								eget turpis. Fusce orci tortor, laoreet ac scelerisque et, mattis sed ex. Integer consequat interdum nibh, quis
								vehicula diam lobortis ac. Sed laoreet lectus quis erat pellentesque molestie. Nulla vitae lorem venenatis,
								porttitor augue sit amet, commodo tortor. Morbi rhoncus neque a purus mattis sagittis. Donec dui magna,
								bibendum a vulputate vel, vehicula vel enim. Sed sit amet magna sed justo lobortis eleifend. Quisque accumsan a
								arcu eu vulputate. Ut sed sollicitudin augue, eu tempus ipsum. Nulla facilisis enim ante, sit amet vulputate
								est vulputate a. Morbi tristique efficitur venenatis. Nulla pretium quis lorem sed rutrum. Nulla rhoncus, justo
								ut molestie dapibus, elit leo iaculis risus, eu pretium eros dui eget libero.
							</p>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-md-12">
							<p class="paragraph text-justify">
								Pellentesque nec lacinia velit, ut dictum diam. Vestibulum eget lorem pharetra leo congue dignissim vel non
								magna. Suspendisse hendrerit quam sit amet interdum eleifend. Curabitur nunc libero, auctor rutrum arcu varius,
								tempor tristique erat. Nullam scelerisque imperdiet tortor nec mattis. Duis lacinia iaculis augue non congue.
								Nam posuere tempor diam, sed finibus nulla congue ut. Interdum et malesuada fames ac ante ipsum primis in
								faucibus. Fusce quis vestibulum sapien. Nam risus lacus, tempus vel fermentum non, hendrerit a nisi.

								Suspendisse feugiat sed tellus id aliquet. Interdum et malesuada fames ac ante ipsum primis in faucibus.
								Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla luctus ut
								nulla elementum ultricies. Phasellus ultricies a augue quis facilisis. Quisque congue enim eget nisl dapibus
								viverra sollicitudin interdum leo. Phasellus condimentum quis odio ut elementum. Suspendisse vitae libero
								felis. Donec sollicitudin neque nec velit dapibus tincidunt. Nullam vel nisi non nunc euismod condimentum ut at
								massa. Etiam et sagittis turpis, sed fermentum metus. Mauris mauris quam, rhoncus nec rhoncus eget, sodales
								vitae nisi. Quisque molestie dictum nisl, ac pharetra neque sagittis at. Nam congue nunc at enim vehicula,
								lobortis imperdiet lacus tempor. Nunc mi turpis, fermentum sit amet urna vel, bibendum blandit velit. Maecenas
								accumsan mauris vitae magna venenatis interdum.

								Integer a bibendum libero. Nunc sit amet varius risus. Nam lacus enim, gravida sed nunc at, luctus pharetra
								velit. Aliquam suscipit, nisl sed aliquet commodo, erat nisi faucibus leo, ut efficitur magna nisl et nisl.
								Duis efficitur lacus libero, in vestibulum dui viverra dignissim. Pellentesque lobortis placerat turpis, vel
								congue est. Nulla venenatis quis libero ac suscipit. Maecenas et libero ut libero elementum vestibulum ut sit
								amet urna. Aliquam non nibh condimentum, lobortis ipsum eget, luctus massa.
							</p>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-12 float-left">
							<div class="row">
								<div class="col-md-1 col-1" style="margin-top: 4px;">
									<img src="images\map.png " height="20px" alt="kumasi ghana" title="khumasi gana">
								</div>

								<div class="col-md-11 div2-gutters-index col-11">
									<h4 class="inline pink"> Kumasi,Ghana</h4>
								</div>
							</div>
						...
						<div class="col-md-6 col-6">
							<div class="row" style="padding-top: 10px;">
								<div class=" col-md-2 gutter-fr-clock">
									<img src="images\ico4.png " height="25px">
								</div>
								<div class="col-md-4 gutter-fr-duration">
									<h4 class="bluebold">Duration</h4>
								</div>
								<div class="col-md-2 gutter-fr-week">
									<select id="normal_select" onchange="cost_update(this)">
						...
						<div class="col-md-6 col-6 show-border" style="margin-top: 8px;margin-bottom: 24px;">
							<div class="row">
								<div class=" col-md-3 gutter-fr-clock">
									<img src="images\ico5.png" height="25px" alt="cost" title="cost">
								</div>
								<div class="col-md-3 gutter-fr-cost">
									<h4 class="bluebold  inline">Cost:</h4>
								</div>
								<div class="col-md-2 gutter-fr-74">
									<span class="pink"><label id="cost_value" value=""></label></span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-6" style="padding-right: 3px;">
							...
							<div class="pt-3">
								<ul class="pt-1 text-muted " style="padding-left: 40px; padding-left: 42px;">
									<li class="pt-1"><img src="images\new-tick.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodation</span></li>
									<li class="pt-2"><img src="images\new-tick.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodation</span></li>
									<li class="pt-2"><img src="images\new-tick.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodation</span></li>
									<li class="pt-2"><img src="images\new-tick.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodation</span></li>
									<li class="pt-2"><img src="images\new-tick.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodation</span></li>
									<li class="pt-2"><img src="images\new-tick.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodation</span></li>
						...
						<div class="col-md-6" style="padding-left: 1px;">
							...
							<div class="pt-3 ">
								<ul class="pt-1 show-border text-muted" style="padding-left: 40px; padding-left:58px;">
									<li class="pt-2"><img src="images\check.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodations</span></li>
									<li class="pt-2"><img src="images\check.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodations</span></li>
									<li class="pt-2"><img src="images\check.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodations</span></li>
									<li class="pt-2"><img src="images\check.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodations</span></li>
									<li class="pt-2"><img src="images\check.png" height="18px" alt="check" title="check"><span class="pl-2">Accomodations</span></li>
				...
				<section id="DATES">
					...
					<div class="row">
						<div class="col-md-12 pt-4">
							<p class="paragraph text-justify">
								...
								Heloo There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration
					...
					<div class="pt-4 pb-4 owl6">
						<!-- //owl carousel -->
						<div class="owl-carousel owl-theme d-md-none d-sm-block d-lg-none">
								<div class="item">
						...
						<div class="table table-responsive-sm table-wrapper  d-lg-block d-md-block d-sm-none display-none-index" width="100%">
							<table class="table-header-blue text-light bordercolor" border="1" width="100%">
								<tr style="text-align: center;">
									<th>January 2018</th>
									<th> February 2018</th>
									<th>March 2018</th>
									<th>April 2018<img class="float-right th-img right" src="images\right-white-arrow.png"
				...
				<section id="ORGANIZATION">
					<div class="row pt-4">
						<div class="col-md-12">
							<h2 class="bluebold pt-5"><?php echo $orgname;?></h2>
						</div>
					</div>
			...
			<div class="col-md-4 display-none apply-form-side">
				<div class="container blueback pl-4 pr-4 pt-3">
					<form class="text-light pt-1 pb-1">
						<div>
							<lable class="text-light box-format"><b>23 people</b> are researching this project</lable>
						</div>
						<div class="pt-2">
						...
						<div class="input-group mb-2">
							<div class="input-group-prepend">
								<div class="input-group-text">
									<img src="images/icon3.png" alt="date" title="date">
								</div>
							</div>
	...
	<div class="row pt-4 d-sm-block d-md-block d-lg-none"  style="align-items: cenblock d-md-block d-lg-noneter;">
		<div class="col-12"> 		
					<button class="btn btn-danger text-light tablet-applynow" id="applynowmobile" style="margin-left:31%;position:relative;padding-left:15px;padding-right:40px">Apply Now<img src="images/right-white-arrow.png" style=" transform: rotate(-90deg); position: absolute; right:14px;"></button>					
		</div>
	...
	<script type="text/javascript" src="js/indexpagejs.js">
	</script>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content" style="background: transparent;border: none;">
				<div class="modal-header" style="border: none;">
					<button type="button" class="close" data-dismiss="modal" style="right: 18px;margin-right: -160px;"><img src="images/cross.png"
						 style="height:25px;"> </button>
				</div>
				<div class="modal-body">
					<img src="images\right-arrow-big.png" id="ninja-slider-next" style="left: 118%;top: 164px;width: auto;height: 43px;position:absolute;">
					<img src="images\left-arrow-big.png" id="ninja-slider-prev" style="left: -24%;top: 164px;width: auto;height: 43px;position:absolute;">

					<div id='ninja-slider'>
						<div>
							<div class="slider-inner">
								<ul>
									<li><a class="ns-img" href="images/banner3.jpg"></a></li>
									<li><a class="ns-img" href="images/banner5.jpg"></a></li>
									<li><a class="ns-img" href="images/banner3.jpg"></a></li>
							...
							<div id="thumbnail-slider">
								<div class="inner">
									<ul>
										<li>
											<a class="thumb" href="images/banner3.jpg"></a>
											<span>0</span>
										</li>
										<li>
											<a class="thumb" href="images/banner5.jpg"></a>
											<span>1</span>
										</li>
										<li>
			...
			<div class="modal-content">
				...
				<div class="modal-header justify-content-center">
					<h4 class="modal-title text-center">
						...
						<button type="button" class="close d-sm-block d-lg-none d-md-block" data-dismiss="modal" style=" position:absolute;right: 18px;margin-right: 0px; background:#ada7a7; top:19px;"><img src="images/cross.png"
							style="height:25px;"> </button>
				...
				<!-- Modal body -->
				<div class="modal-body">
					<form action="ction_page.php" name="popupform" onsubmit="return validateForm()">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" placeholder="mm/dd/yyyy" class="form-control" id="datepicker3" name="datepicker3"
								 autocomplete="off">
							</div>
							<ul class="padding-left-0px">
