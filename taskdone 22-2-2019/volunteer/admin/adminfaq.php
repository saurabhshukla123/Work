	...
	if ($_SESSION['role'] == "superadmin") {     
		...
		{		
				if ($_SERVER['REQUEST_METHOD'] == 'POST') {
					...
					$q1=new faq();
					$value=$q1->insert($question,$answer,$sequencenumber);
			...
			$faq_get_details1=new faq();
			$result_faq=$faq_get_details1->faqdetails($projectid);
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				$faq_update=new faq();
				$result_faq_update=$faq_update->updateFaq($question, $answer, $projectid,$sequencenumber);
